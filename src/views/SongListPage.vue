  ...
  <div class="songlistpage">
    <div class="songlistpage-box" v-if="!isShow">
      ...
      >
        ...
        <div class="bg-bottom">
          <h2 class="name">{{ songListData.name }}</h2>
          <h4>
      ...
      <div class="song-list">
        <div class="song-list-top clearfix">
          ...
          <div class="all-songs">
            播放全部
            <span v-if="songListData.tracks"
              >(共{{ songListData.tracks.length }}首)</span
            >
          </div>
        </div>
        <ul>
          ...
          >
            ...
            <div class="song-text">
              <h3 class="song-name one-text">{{ item.name }}</h3>
              <p class="singer one-text">{{ item.ar[0].name }}</p>
            </div>
          </li>
        </ul>
      </div>
        ...
        .then((result) => {
          if (result.data.code == 200) {
            ...
            for (let key in songListData.tracks) {
              if (songListData.tracks[key].ar.length > 1) {
                songListData.tracks[key].ar[0].name =
                  songListData.tracks[key].ar[0].name +
                  "/" +
                  songListData.tracks[key].ar[1].name;
              }
            }
